...
function sendBookData(bookData, cookies, lastBook) {
  ...
  let needToSendFinalBookToCreateResync = lastBook && window.syncedNewChanges;
  if (!needToSendFinalBookToCreateResync && (bookMatchesPreviousSync || bookData[window.currentBookId].quotes.length === 0)) {
